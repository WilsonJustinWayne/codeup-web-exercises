    ...
    function doMath(operator, a, b) {
        // switch (operator) {
            // case "add"/*, "subtract", "multiply", "divide", "remainder" */:
                console.log(typeof operator + "," + operator.valueOf());
                var functionName = window[operator];
                console.log(typeof functionName + "," + functionName.valueOf());
                return functionName(parseInt(a), parseInt(b));
                // break;
            // default :
            //     return alert("You did not spell the mathematic function correctly, or you put in an option not available.")
        // }
    }
console.log(doMath(prompt("Please type the operator you would like to use in this equation. (ie. add, subtract, multiply, divide, remainder)"),
    prompt("Please type the first number in your equation."),
    prompt("Please type the second number in your equation.")));
