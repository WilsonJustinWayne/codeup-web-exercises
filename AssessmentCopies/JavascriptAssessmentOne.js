...
function increment(input) {
    return (isNaN(input) || typeof input === "boolean" || input === null ? false : parseFloat(input) + 1);
}
...
function square(input) {
    return (isNaN(input) || typeof input === "boolean" || input === null ? false : input * input);
}
...
function upperCase(input) {
    return (typeof input !== "string" ? false : !isNaN(parseFloat(input)) ? false : input.toUpperCase());
}
...
function isPalindrome(input) {
    return (typeof input === "string" ? input.toLowerCase() === input.toLowerCase().split("").reverse().join("") : false);
}
...
function getHighestNumber(a, b, c) {
    return (typeof a === "number" && typeof b === "number" && typeof c === "number" ? Math.max(a, b, c) : false);
}
...
function containsVowel(input) {
    return (typeof input !== "string" ? false : input.includes("a") || input.includes("e") || input.includes("i") || input.includes("o") || input.includes("u"));
}
...
function add(a, b) {
    return (!isNaN(parseFloat(a) + (parseFloat(b))) ? parseFloat(a) + parseFloat(b) : false );
}
...
function sumOfSquares(a, b) {
    return (!isNaN(parseFloat(a) + parseFloat(b)) ? (parseFloat(a) * parseFloat(a)) + (parseFloat(b) * parseFloat(b)) : false);
}
